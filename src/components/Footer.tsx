      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-gray-400">
              Fournisseur de joies et de bonheur. Découvrez l'Afrique de l'Ouest avec des experts passionnés.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/calendar" className="text-gray-400 hover:text-white transition-colors">Calendrier des départs</Link></li>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-500 text-sm mb-4 md:mb-0">
            &copy; {new Date().getFullYear()} LRAD Tourisme. Tous droits réservés.
          </p>
